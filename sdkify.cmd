...
REM %XCOPY_DIR% "%MG_SRC_DIR%\Oem\dbxml\xerces-c-src\src\*.h" "%MG_SDK_OUTPUT_DIR%\Inc\xerces"
REM %XCOPY_DIR% "%MG_SRC_DIR%\Oem\dbxml\xerces-c-src\src\*.hpp" "%MG_SDK_OUTPUT_DIR%\Inc\xerces"
REM %XCOPY_DIR% "%MG_SRC_DIR%\Oem\dbxml\xerces-c-src\src\*.c" "%MG_SDK_OUTPUT_DIR%\Inc\xerces"
