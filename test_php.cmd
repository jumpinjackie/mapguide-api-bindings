...
set RELPATH=Release\x64
if "%1" == "Release" (
    set CONFIG=%1
    set BINPREFIX=Bin
    set RELPATH=Release\x86
)
...
copy /Y "%CD%\packages\php\%RELPATH%\php_MapGuideApi.*" "%PHP_EXT_DIR%"
copy /Y "%CD%\packages\php\%RELPATH%\*.php" "%CD%\src\Test\Php"
