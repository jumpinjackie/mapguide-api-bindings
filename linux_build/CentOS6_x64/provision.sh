...
#DOWNLOAD_URL=http://192.168.0.2/releases/$MG_VER_MAJOR.$MG_VER_MINOR.$MG_VER_REV/Final/centos6_x64/mginstallcentos.sh
DOWNLOAD_URL=http://download.osgeo.org/mapguide/releases/$MG_VER_MAJOR.$MG_VER_MINOR.$MG_VER_REV/Final/centos6_x64/mginstallcentos.sh
