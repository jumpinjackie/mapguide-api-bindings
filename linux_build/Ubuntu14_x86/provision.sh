...
#DOWNLOAD_URL=http://192.168.0.2/releases/$MG_VER_MAJOR.$MG_VER_MINOR.$MG_VER_REV/Final/ubuntu14_x86/mginstallubuntu.sh
DOWNLOAD_URL=http://download.osgeo.org/mapguide/releases/$MG_VER_MAJOR.$MG_VER_MINOR.$MG_VER_REV/Final/ubuntu14_x86/mginstallubuntu.sh
...
cp $SRC_AREA/packages/Java/Release/x86/Ubuntu14.04.i686/libMapGuideJavaApi.so /mapguide_sources/packages/Java/Release/x86/Ubuntu14.04.i686